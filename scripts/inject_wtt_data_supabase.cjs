...
// 제품 45개 모델 목록
const productModels = [
  { id: 'PROD-0000001', modelName: 'S-45', manufacturer: 'Genie', feet: 45 },
  { id: 'PROD-0000002', modelName: 'S-60', manufacturer: 'Genie', feet: 60 },
  { id: 'PROD-0000003', modelName: 'S-65', manufacturer: 'Genie', feet: 65 },
  { id: 'PROD-0000004', modelName: 'S-80', manufacturer: 'Genie', feet: 80 },
  { id: 'PROD-0000005', modelName: 'S-85', manufacturer: 'Genie', feet: 85 },
  { id: 'PROD-0000006', modelName: 'Z-34/22N', manufacturer: 'Genie', feet: 34 },
  { id: 'PROD-0000007', modelName: 'Z-45/25J', manufacturer: 'Genie', feet: 45 },
  { id: 'PROD-0000008', modelName: 'Z-60/34', manufacturer: 'Genie', feet: 60 },
  { id: 'PROD-0000009', modelName: 'SJ3219', manufacturer: 'SKYJACK', feet: 19 },
  { id: 'PROD-0000010', modelName: 'SJ3226', manufacturer: 'SKYJACK', feet: 26 },
  { id: 'PROD-0000011', modelName: 'SJ4626', manufacturer: 'SKYJACK', feet: 26 },
  { id: 'PROD-0000012', modelName: 'SJ4632', manufacturer: 'SKYJACK', feet: 32 },
  { id: 'PROD-0000013', modelName: 'SJ6826RT', manufacturer: 'SKYJACK', feet: 26 },
  { id: 'PROD-0000014', modelName: 'SJ6832RT', manufacturer: 'SKYJACK', feet: 32 },
  { id: 'PROD-0000015', modelName: 'SJ8841RT', manufacturer: 'SKYJACK', feet: 41 },
  { id: 'PROD-0000016', modelName: '1930ES', manufacturer: 'JLG', feet: 19 },
  { id: 'PROD-0000017', modelName: '2030ES', manufacturer: 'JLG', feet: 20 },
  { id: 'PROD-0000018', modelName: '2630ES', manufacturer: 'JLG', feet: 26 },
  { id: 'PROD-0000019', modelName: '2646ES', manufacturer: 'JLG', feet: 26 },
  { id: 'PROD-0000020', modelName: '3246ES', manufacturer: 'JLG', feet: 32 },
  { id: 'PROD-0000021', modelName: 'E400AJPN', manufacturer: 'JLG', feet: 40 },
  { id: 'PROD-0000022', modelName: 'E450AJ', manufacturer: 'JLG', feet: 45 },
  { id: 'PROD-0000023', modelName: '600AJ', manufacturer: 'JLG', feet: 60 },
  { id: 'PROD-0000024', modelName: '800AJ', manufacturer: 'JLG', feet: 80 },
  { id: 'PROD-0000025', modelName: '1250AJP', manufacturer: 'JLG', feet: 125 },
  { id: 'PROD-0000026', modelName: 'ES1330L', manufacturer: 'JLG', feet: 19 },
  { id: 'PROD-0000027', modelName: 'GS-1432', manufacturer: 'Genie', feet: 19 },
  { id: 'PROD-0000028', modelName: 'SJ3215', manufacturer: 'SKYJACK', feet: 19 },
  { id: 'PROD-0000029', modelName: 'GTJZ0608ME', manufacturer: 'SINOBOOM', feet: 19 },
  { id: 'PROD-0000030', modelName: 'GTJZ0812E', manufacturer: 'SINOBOOM', feet: 19 },
  { id: 'PROD-0000031', modelName: 'GTJZ0808E', manufacturer: 'SINOBOOM', feet: 19 },
  { id: 'PROD-0000032', modelName: 'GTJZ1012E', manufacturer: 'SINOBOOM', feet: 19 },
  { id: 'PROD-0000033', modelName: 'GTJZ1212E', manufacturer: 'SINOBOOM', feet: 19 },
  { id: 'PROD-0000034', modelName: '1414E Plus', manufacturer: 'SINOBOOM', feet: 19 },
  { id: 'PROD-0000035', modelName: 'GS-1930', manufacturer: 'Genie', feet: 19 },
  { id: 'PROD-0000036', modelName: 'GS-1930 E-Drive', manufacturer: 'Genie', feet: 19 },
  { id: 'PROD-0000037', modelName: 'GS-2646', manufacturer: 'Genie', feet: 19 },
  { id: 'PROD-0000038', modelName: 'GS-2632  E-Drive', manufacturer: 'Genie', feet: 19 },
  { id: 'PROD-0000039', modelName: 'GS-3246', manufacturer: 'Genie', feet: 19 },
  { id: 'PROD-0000040', modelName: 'GS-3246 E-Drive', manufacturer: 'Genie', feet: 19 },
  { id: 'PROD-0000041', modelName: 'GS-4047', manufacturer: 'Genie', feet: 19 },
  { id: 'PROD-0000042', modelName: 'GS-4655', manufacturer: 'Genie', feet: 19 },
  { id: 'prod-1', modelName: 'SKY-800', manufacturer: 'SKY', feet: 8 },
  { id: 'prod-2', modelName: 'GENIE-1000', manufacturer: 'GENIE', feet: 10 },
  { id: 'prod-3', modelName: 'LIFT-1200', manufacturer: 'LIFT', feet: 12 }
];

// 1. 테스터 직원
const users = [
  { id: 'usr-tester-admin', name: '테스터(총괄관리)', username: 'admin_tester', passwordHash: '1234', role: 'ADMIN', departmentId: 'DEPT-0000001', email: '77.victor.lee@gmail.com', phone: '010-1111-0001', isActive: true, createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' },
  { id: 'usr-tester-sales', name: '테스터(계약관리)', username: 'sales_tester', passwordHash: '1234', role: 'USER', departmentId: 'DEPT-0000003', email: '77.victor.lee@gmail.com', phone: '010-1111-0002', isActive: true, createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' },
  { id: 'usr-tester-billing', name: '테스터(청구수납)', username: 'billing_tester', passwordHash: '1234', role: 'USER', departmentId: 'DEPT-0000002', email: '77.victor.lee@gmail.com', phone: '010-1111-0003', isActive: true, createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' },
  { id: 'usr-tester-purchase', name: '테스터(매입급여)', username: 'purchase_tester', passwordHash: '1234', role: 'USER', departmentId: 'DEPT-0000002', email: '77.victor.lee@gmail.com', phone: '010-1111-0004', isActive: true, createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' },
  { id: 'usr-tester-dispatch', name: '테스터(배차출고)', username: 'dispatch_tester', passwordHash: '1234', role: 'USER', departmentId: 'DEPT-0000004', email: '77.victor.lee@gmail.com', phone: '010-1111-0005', isActive: true, createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' },
  { id: 'usr-tester-mechanic', name: '테스터(정비관리)', username: 'mechanic_tester', passwordHash: '1234', role: 'USER', departmentId: 'DEPT-0000005', email: '77.victor.lee@gmail.com', phone: '010-1111-0006', isActive: true, createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' }
];
...
const consumables = [
  ...
  { id: 'CON-0000007', modelName: '유압 호스 고압 1/2인치 (5m)', unit: 'EA', unitPrice: 85000, stockQty: 60, createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' },
  { id: 'CON-0000008', modelName: '상승 리미트 센서 스위치', unit: 'EA', unitPrice: 65000, stockQty: 70, createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' },
  { id: 'CON-0000009', modelName: '충전기 내장형 24V 25A', unit: 'EA', unitPrice: 550000, stockQty: 30, createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' },
  { id: 'CON-0000010', modelName: '기울기 경보 센서(Tilt Sensor)', unit: 'EA', unitPrice: 180000, stockQty: 40, createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' }
];
...
productModels.forEach(p => {
  for (let i = 1; i <= 20; i++) {
    ...
    assets.push({
      ...
      serialNo: `SN-${p.manufacturer.slice(0, 3).toUpperCase()}-${acqYear}-${String(assetIdx).padStart(4, '0')}`,
...
for (let i = 1; i <= 600; i++) {
  ...
  const p = productModels[(i - 1) % productModels.length];
...
const settlementPaymentLogs = [];
const billings = [];
const billingDetails = [];
const payments = [];
const paymentDepositLinks = [];
...
months.forEach((ym, mIdx) => {
  ...
  customers.forEach((cust, cIdx) => {
    ...
    paymentDepositLinks.push({
      id: `PDL-${String(pdlSeq++).padStart(7, '0')}`,
  ...
  transportCompanies.forEach((tc, tcIdx) => {
    ...
    settlementPaymentLogs.push({
      id: `SPL-${String(splSeq++).padStart(7, '0')}`,
      settlementId: pstId,
      paidAmount: tAmount,
      paymentDate: `${ym}-30`,
      paymentMethod: '계좌이체',
      memo: `${ym} 배차 운송비 정산 대금 전액 지급 완료`
    });
  });
  ...
  vendors.filter(v => v.types && v.types.includes('RENTAL')).forEach((v, vIdx) => {
    ...
    settlementPaymentLogs.push({
      ...
      paymentDate: `${ym}-30`,
      paymentMethod: '계좌이체',
      memo: `${ym} 외부 전대 장비 임차료 정산 대금 전액 지급 완료`
    });
  });
});
...
async function main() {
  console.log('=== Supabase WTT 정밀 스키마 배치 주입 시작 ===');
  ...
  await upsertBatch('payment_deposit_links', paymentDepositLinks, 100);
  
  // 7단계: 3대 매입정산 & 지급이력
  await upsertBatch('purchase_settlements', purchaseSettlements, 100);
  await upsertBatch('settlement_payment_logs', settlementPaymentLogs, 100);
